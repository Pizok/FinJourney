...
export default function Footer() {
  return (
    <footer className="bg-midnight-sky border-t border-clean-border">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
          ...
          <Link href="/" className="flex items-center gap-2.5 shrink-0">
            ...
            <span className="font-display font-semibold text-base text-starlight-text tracking-tight">
              FinJourney
            </span>
          </Link>
        ...
        {/* Copyright */}
        <div className="mt-8 pt-8 border-t border-clean-border">
