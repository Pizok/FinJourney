...
export const MAP_NODES = [
  ...
  { id: "2-1", region: 2, label: "Bogwater Landing",  story: "The mainland smells of rot and rain. Every step forward costs something.",                          x: 88, y: 75 },
  { id: "2-2", region: 2, label: "The Sunken Road",   story: "The path is swallowed by murk. You must feel your way through.",                                    x: 78, y: 80 },
  { id: "2-3", region: 2, label: "Thornwall",         story: "Dense and unforgiving. The forest tests your patience before your strength.",                       x: 62, y: 82 },
  { id: "2-4", region: 2, label: "The Rotwood",       story: "Trees that look solid crumble at the touch. Trust nothing that hasn't been tested.",                x: 50, y: 78 },
  { id: "2-5", region: 2, label: "The Bay Shore",     story: "The bog gives way to open sand. You breathe again. The mountain looms ahead.",                     x: 56, y: 68 },
  { id: "2-6", region: 2, label: "Stonefoot",         story: "The trees thin. Rock replaces mud. The mountain is no longer a rumor.",                            x: 67, y: 62 },
  ...
  { id: "3-1", region: 3, label: "The Threshold",     story: "You stand between two dark openings. Either way leads through. You must choose.",                   x: 74, y: 57 },
  { id: "3-2", region: 3, label: "Cave of Echoes",    story: "The left tunnel. Voices of doubt bounce off every wall. You pass through anyway.",                  x: 70, y: 50 },
          ...
          <div className="animate-fade-in rounded-xl border border-tactical-border bg-canvas-surface p-4 flex items-start gap-4">
            <div
              className={`mt-0.5 w-9 h-9 rounded-full flex items-center justify-center shrink-0 ${
                selectedStatus === "SHIFTED" ? "bg-muted-emerald/15" : "bg-dawn-gold/15"
              }`}
            >
              <MapPin
                strokeWidth={2}
                className={`w-4 h-4 ${
                  selectedStatus === "SHIFTED" ? "text-muted-emerald" : "text-dawn-gold"
                }`}
              />
            </div>
